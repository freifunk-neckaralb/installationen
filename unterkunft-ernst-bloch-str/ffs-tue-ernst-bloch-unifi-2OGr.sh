# /bin/sh
# FW version 0.7
# Unifi AP im Heizungsraum EG links

# Hostname
uci set system.@system[0].hostname='ffs-tue-ernst-bloch-unifi-2OGr'
uci commit
...
uci set gluon-node-info.@location[0].latitude='48.51711100285213'
uci set gluon-node-info.@location[0].longitude='9.045395404127703'
uci commit
