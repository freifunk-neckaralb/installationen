...
# Hostname
uci set system.@system[0].hostname='ffs-tue-ernst-bloch-unifi-EGl'
uci commit
...
uci set gluon-node-info.@location[0].latitude='48.51703282863175'
uci set gluon-node-info.@location[0].longitude='9.045293480185137'
uci commit
