...
# Mesh on WAN
uci set network.mesh_wan.auto=1 #an, damit theoretisch Mesh über Kabel möglich ist
...
uci set gluon-node-info.@location[0].latitude='48.498357875'
uci set gluon-node-info.@location[0].longitude='9.030858278'
