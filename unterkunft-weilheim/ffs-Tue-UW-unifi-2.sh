...
# IPv6: http://[fd21:b4dc:4b02:0:46d9:e7ff:fecd:641d]/

# Hostname
uci set system.@system[0].hostname='ffs-Tue-UW-unifi-2'
...
# Mesh on WAN
uci set network.mesh_wan.auto=1 #an, damit Unifi theoretisch über Kabel meshen kann
...
uci set gluon-node-info.@location[0].latitude='48.498055726'
uci set gluon-node-info.@location[0].longitude='9.030104578'
