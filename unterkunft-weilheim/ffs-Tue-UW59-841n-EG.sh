...
# Hostname
uci set system.@system[0].hostname='ffs-Tue-UW59-841n-EG'
...
uci set gluon-node-info.@location[0].latitude='48.49800092438149'
uci set gluon-node-info.@location[0].longitude='9.030230194357'
